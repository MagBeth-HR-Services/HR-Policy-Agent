...
- Evaluation still needs a live OpenRouter run after the 24-case expansion. Do not treat the previous 10/10 `results.json` as the final score.
- The assistant cannot record the 7–10 minute video, show government ID, invite `quantic-grader`, or click Render deploy.
